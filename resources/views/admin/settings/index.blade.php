        ...
        <div class="col-md-9">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="site-logo">
                    @include('admin.settings._logo')
                </div>
                <div class="tab-pane fade" id="footer-seo">
                    @include('admin.settings._footer_seo')
                </div>
                <div class="tab-pane fade" id="social-links">
                    @include('admin.settings._social_links')
                </div>
                <div class="tab-pane fade" id="analytics">
                    @include('admin.settings._analytics')
                </div>
                <div class="tab-pane fade" id="payments">
                    @include('admin.settings._payments')
                </div>
            </div>
        </div>
    </div>
